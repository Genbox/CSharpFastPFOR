...
{
    public /* final */ class NewPFDS16 : IntegerCODEC,SkippableIntegerCODEC {
        ...
        private void decodePage(int[] @in, IntWrapper inpos, int[] @out,
            ...
            for (int run = 0; run < thissize / BLOCK_SIZE; ++run, tmpoutpos += BLOCK_SIZE) {
                ...
                /* final */ int cexcept = (int)((uint)@in[tmpinpos] >> 8) & 0xFF;
                /* final */ int exceptsize = (int)((uint)@in[tmpinpos] >> 16);
                ++tmpinpos;
